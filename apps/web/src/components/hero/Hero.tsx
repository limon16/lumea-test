  ...
  return (
    ...
    >
      <div aria-hidden="true"
        className="pointer-events-none absolute inset-0 -z-10 bg-[url('/images/hero-blur-ellipses-mobile.svg')] bg-cover bg-center md:bg-[url('/images/hero-blur-ellipses.svg')] md:bg-size-[100%_auto] md:bg-top md:bg-no-repeat" />
      ...
      <div className="mx-auto w-full max-w-[1280px]">
        ...
        <div className="px-[22px] text-center md:px-3.5 md:text-left">
          <h1
            id="hero-heading"
            className="mt-6 text-[40px]/[0.8] font-bold tracking-[-0.02em] text-(--color-ink)
          ...
          >
            ...
            <span className="block md:flex md:items-center
                             md:justify-between md:gap-8 xl:-mt-1.5">
              <span
                className="mt-[15px] mb-[25px] mx-auto block max-w-[24ch]
                           ...
                           xl:w-[391px] xl:max-w-none xl:shrink-0 xl:translate-x-4 xl:translate-y-[19px]"
              >
                Thoughtful formulas for{' '}
                <span className="inline md:block">healthy, glowing skin</span>
              </span>
              <span className="block text-[#00c3d0] md:text-[#00c0e8] mr-6">
                simple
              </span>
            </span>
          </h1>
        ...
        <div className="mt-6 flex flex-col gap-8 px-[22px] md:mt-[58px]
          ...
          <div className="flex w-fit flex-col items-center gap-2 mx-auto
                          md:mx-0 md:col-span-2 md:pt-[60px]
          ...
          <div className="mt-0.5 w-full max-w-[353px] rounded-xl border border-white/80 p-2.5 mx-auto
                          md:col-span-full md:row-start-3 md:ml-auto md:mr-[78px] md:mt-4.5
                          lg:row-start-2 xl:py-2">
          ...
          <div className="flex flex-col gap-8 md:col-start-1 md:row-start-2
            ...
            <div className="relative aspect-[562/374] w-full overflow-hidden
                            rounded-[30px] bg-(--color-border) xl:h-[374px]">
              <Image
          ...
          <div className="hidden md:flex md:flex-col md:items-center
            ...
            <article className="relative z-10 flex w-[246px] flex-col gap-3
                                rounded-[32px] bg-(--color-paper) px-5 py-6">
